...
import com.idat.EC2DiandraRimabaqueBodega.service.ProductoService;
...
public class ProductoController {
	...
	public ResponseEntity<Void> eliminar(@PathVariable Integer id) {
		...
		ProductoDTOResponse producto = service.obtenerProductosId(id);
	...
	public ResponseEntity<Void> actualizar(@RequestBody ProductoDTORequest productos) {
		...
		ProductoDTOResponse producto =service.obtenerProductosId(productos.getIdProducto());
